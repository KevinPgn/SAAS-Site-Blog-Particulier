...
export const SidebarProfile = () => {
  ...
  return <div className="w-[290px] p-3 flex flex-col gap-2 h-full border-r border-gray-300">
    <Link href="/profile/dashboard" className={`flex items-center gap-2 px-5 py-3 rounded-lg hover:bg-gray-100 duration-75 ${pathname === '/profile/dashboard' ? 'bg-gray-100 text-blue-500' : ''}`}>
      <Home size={20} />
